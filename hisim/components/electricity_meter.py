...
class ElectricityMeter(DynamicComponent):
    ...
    def __init__(
        ...
        self.add_dynamic_default_connections(self.get_default_connections_from_generic_heat_pump())
    ...
    def get_default_connections_from_generic_heat_pump(
        ...
        from hisim.components.generic_heat_pump import (  # pylint: disable=import-outside-toplevel
            GenericHeatPump,
        )
